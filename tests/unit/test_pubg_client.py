...
class TestAPIKeyIntegration:
    ...
    @patch('requests.get')
    def test_uses_api_key_from_manager(self, mock_get, mock_key_manager, mock_get_existing_match_ids):
    ...
    @patch('requests.get')
    def test_records_request_with_manager(self, mock_get, mock_key_manager, mock_get_existing_match_ids):
