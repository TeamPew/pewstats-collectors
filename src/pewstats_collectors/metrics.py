...
API_RATE_LIMIT_REMAINING = Gauge(
    'pubg_api_rate_limit_remaining',
    'Remaining PUBG API rate limit',
    ['endpoint']
)

API_RATE_LIMIT_RESETS_AT = Gauge(
    'pubg_api_rate_limit_resets_at',
    'Unix timestamp when PUBG API rate limit resets',
    ['endpoint']
)

# Business metrics
MATCHES_IN_DATABASE = Gauge(
    'matches_in_database_total',
    'Total number of matches in database'
)

TELEMETRY_FILES_IN_DATABASE = Gauge(
    'telemetry_files_in_database_total',
    'Total number of telemetry files in database'
)
